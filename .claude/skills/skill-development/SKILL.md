...
Using exclamation-backtick syntax (e.g., `! + backtick + command + backtick`) in code blocks.

**Why bad:** Parser executes the pattern during skill load, even inside code blocks. Backslash escaping does NOT work.
